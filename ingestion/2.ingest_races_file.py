...
from pyspark.sql.types import StructType,StructField,IntegerType,StringType,DataType,DateType
...
races_df=spark.read.option("header",True).schema(races_schema).csv("/mnt/formulaones/raw/races.csv")
...
races_selected_df.write.mode('overwrite').partitionBy('race_year').parquet('/mnt/formulaones/processed/races')

# COMMAND ----------

display(spark.read.parquet('/mnt/formulaones/processed/races'))
