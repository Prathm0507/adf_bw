...
lap_times_df=spark.read.schema(lap_times_schema).csv("/mnt/formulaones/raw/lap_times")
...
final_df.write.mode("overwrite").parquet("/mnt/formulaones/processed/lap_times")
